...
static const u4_t DEVADDR = 0xBACEBACE; // <-- Change this address for every node!
...
void do_send(osjob_t* j){
    ...
    if (LMIC.opmode & OP_TXRXPEND) {
        ...
        // float -> int
        // note: this uses the sflt16 datum (https://github.com4C6F/mcci-catena/arduino-lmic#sflt16)
